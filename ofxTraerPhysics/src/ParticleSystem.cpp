...
namespace traer { namespace physics {
    ...
    //--------------------------------------------------------------
    Particle* ParticleSystem::makeParticle( float mass, float x, float y, float z, float radius )
    {
    ...
    {  
        return makeParticle( 1.0f, 0.0f, 0.0f, 0.0f, 10.0 );
    }

    //--------------------------------------------------------------
    Particle* ParticleSystem::makeParticle( float mass, ofPoint p, float radius){
    
        return makeParticle( mass, p.x, p.y, p.z, radius);
    ...
    void ParticleSystem::setBounds(float x_, float y_, float w_, float h_)
    {
        x=x_;
        y=y_;
        w=w_;
